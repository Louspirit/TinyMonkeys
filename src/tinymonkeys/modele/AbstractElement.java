...
public abstract class AbstractElement 
{
	 ...
	 * @param x la coordonnee en abscisse de l'element.
	 * @param y la coordonnee en ordonnee de l'element.
	 */
	 ...
	 * @param x la nouvelle coordonnee en abscisse de l'element.
	 * @param y la nouvelle coordonnee en ordonnee de l'element.
	 */
	...
	/**
	 * Retourne vrai si les coordonnees de l'element sont egales a celles indiquees, faux sinon.
	 * 
	 * @param x la coordonnee en abscisse.
	 * @param y le coordonnee en ordonnee.
	 * @return vrai ou faux selon l'egalite des coordonnees.
	 */
	public boolean coordonneesEgales(int x, int y)
	{
