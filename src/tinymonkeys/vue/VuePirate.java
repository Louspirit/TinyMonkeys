...
public class VuePirate extends VuePersonnage
{
	 ...
	 * @param x la position en abscisse du pirate (nombre de  cases).
	 * @param y la position en ordonnee du pirate (nombre de cases).
	 * @param avatar le lien vers l'avatar du pirate.
	 */
	public VuePirate(int tailleCase, int xGrille, int yGrille, int x, int y, String avatar)
	{
